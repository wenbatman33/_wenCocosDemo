System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "50e5aMqp4FAI7dDK958lhVs", "test_1", undefined);
      ...
      _export("main", main = (_dec = ccclass("main"), _dec(_class = class main extends Component {
        ...
        onTouchStart(event) {
          ...
          const touchLocalPos = parentTransform.convertToNodeSpaceAR(new Vec3(uiPos.x, uiPos.y, 0)); // 取得物件目前的位置

          const charPos = char.getPosition(); // 計算偏移量：物件位置 - 觸摸位置
        ...
        onTouchMove(event) {
          ...
          const uiPos = event.getUILocation();
          const touchLocalPos = parentTransform.convertToNodeSpaceAR(new Vec3(uiPos.x, uiPos.y, 0)); // 套用偏移量：新位置 = 觸摸位置 + 偏移量
...
//# sourceMappingURL=00820f3cd1c9d86810db79f31fc307481bf74478.js.map